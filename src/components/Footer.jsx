            ...
            <ul className="contact-details">
              <li className="contact-detail-item">
                ...
                <div>
                  ...
                  <p className="body-regular">123 Luxury Ave, Design District, Dubai, UAE</p>
                </div>
              </li>
              <li className="contact-detail-item">
                <div className="contact-icon">
                ...
                <div>
                  ...
                  <p className="body-regular">+971 50 123 4567</p>
                </div>
              </li>
              <li className="contact-detail-item">
                <div className="contact-icon">
                ...
                <div>
                  ...
                  <p className="body-regular">info@tharaadev.com</p>
                </div>
              </li>
            </ul>
          </div>
            ...
            <form className="contact-form" onSubmit={handleSubmit} noValidate>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  className="form-input" placeholder="+971 50 000 0000"
                  autoComplete="tel"
                />
              </div>
              <div className="form-group">
          ...
          <div className="footer-links-grid">
            ...
            <div className="footer-col">
              ...
              <ul>
                ...
                <li><a href="#renovation" className="body-small">Renovation</a></li>
                <li><a href="#consulting" className="body-small">Consulting</a></li>
              </ul>
            </div>
            <div className="footer-col">
              <h3 className="footer-col-title caption">Contact</h3>
              <ul>
                <li className="body-small">info@tharaadev.com</li>
                <li className="body-small">+971 50 123 4567</li>
                <li className="body-small">Dubai, UAE</li>
              </ul>
            </div>
          </div>
        </div>
